...
!(function (e) {
    ...
    if (
        ...
        e(".image-popup").length &&
            ...
            e(".image-popup").magnificPopup({ type: "image", gallery: { enabled: !0 } }),
        e(".video-popup").length && "magnificPopup" in jQuery && e(".video-popup").magnificPopup({ type: "iframe" }),
        o > 767 &&
            ...
            i = (e) => {
                e.forEach((e) => {
                    ...
                    e.isIntersecting &&
                        ...
                        (a(t, { duration: 1500, delay: 16 }), t.classList.add("is-visible"));
                });
            },
    ...
    l.forEach((t, o) => {
        e(t).mousemove(function (s) {
            ...
            (a = s),
                ...
                (n = u[o]),
                (c = e(t)),
                (l = i.pageX - c.offset().left),
                (d = i.pageY - c.offset().top),
                gsap.to(n, 0.3, {
            ...
            e(t).mouseleave(function (e) {
                gsap.to(u[o], 0.3, { x: 0, y: 0, scale: 1, ease: Power2.easeOut });
            });
    });
    ...
    if (d) {
        ...
        e(".btn-hover-bgchange").on("mouseenter", function (t) {
            ...
            e(this).find("span").css({ top: s, left: o });
        }),
    ...
    document.querySelector(".pin__element") &&
        o > 991 &&
        ...
        document.querySelector(".pin__elem") &&
            ...
            gsap.utils.toArray(".pin__elem").forEach((e, t, o) => {
                t !== o.length - 1 && ScrollTrigger.create({ trigger: e, start: "top top", pin: !0, pinSpacing: !1 });
            }),
    ...
    document.querySelectorAll(".img_anim_reveal").forEach((e) => {
        ...
        o.set(e, { autoAlpha: 1 }),
            ...
            o.from(t, 1.5, { xPercent: 100, scale: 1.3, delay: -1.5, ease: Power2.out });
    });
    ...
    e(".overlay-switcher-close").on("click", function () {
        ...
        e(".layout-type button").on("click", function (t) {
            e(this).addClass("active").siblings().removeClass("active"),
                "box-layout" == e(".layout-type button.active").attr("data-mode")
                    ? (e("#smooth-content").addClass("box-layout"), e("header").addClass("box-layout"))
                    : (e("#smooth-content").removeClass("box-layout"), e("header").removeClass("box-layout"));
        }),
...
>>>>>>> 41cef709e016914a6691ed35a3cebeae765996db
